...
void cli_print_error(cli_error_t const* error) {
    ...
    switch (error->error_code) {
        case CLI_ERROR:                   msg = "Unspecified error occurred"; break;
        case CLI_ERROR_MISSING_ARGUMENT:  msg = "Parameter is missing an argument"; break;
        case CLI_ERROR_INVALID_ARGUMENT:  msg = "Parameter was given an invalid argument"; break;
        case CLI_ERROR_UNKNOWN_PARAMETER: msg = "Unknown parameter encountered"; break;
        case CLI_ERROR_INVALID_PARAMETER_TYPE:
            msg = "Parameter was given or accessed with an invalid type";
            break;
        case CLI_ERROR_DUPLICATE_PARAMETER: msg = "Duplicate parameter encountered"; break;
    }

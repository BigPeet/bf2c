...
static cli_result_t cli_parse_param_arguments(cli_param_t* param,
                                              int* index,
                                              int argc,
                                              char** argv) {
    assert(param);
...
static cli_result_t cli_parse_long_option(cli_t const* cli,
                                          char const* argument,
                                          int* index,
                                          int argc,
                                          char** argv) {
...
static cli_result_t cli_parse_short_options(cli_t const* cli,
                                            char const* argument,
                                            int* index,
                                            int argc,
                                            char** argv) {
